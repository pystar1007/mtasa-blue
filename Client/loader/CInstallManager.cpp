...
SString CInstallManager::_ProcessGtaDllCheck()
{
    ...
    // clang-format off            //RUN SILENT ASI LOADER DLLS
    constexpr std::array<DependencyHash, 5> dependencies{{
        ...
        {"vorbisFile.dll",  FileHash{0x6C, 0xCF, 0x42, 0x58, 0x7C, 0xAE, 0xEE, 0x3A, 0x09, 0xF6, 0x37, 0x2A, 0x4E, 0x73, 0xCC, 0x65,
                                     0x7E, 0xA6, 0x7C, 0x7F, 0xDC, 0x02, 0x34, 0x01, 0x7A, 0x39, 0xAD, 0xAA, 0xC6, 0xD7, 0xBC, 0x80}},
        {"vorbisHooked.dll",FileHash{0xA0, 0x89, 0x23, 0x47, 0x90, 0x00, 0xCE, 0xC3, 0x66, 0x96, 0x7F, 0xB8, 0x25, 0x9E, 0x09, 0x20,
